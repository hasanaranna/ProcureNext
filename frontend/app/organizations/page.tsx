    ...
    <main className="w-full min-h-screen py-10 px-4 bg-gradient-to-br from-navy-950 via-navy-900 to-navy-800">
      <div className="max-w-6xl mx-auto animate-fade-in">
        ...
        {notification && (
          ...
          >
            <span className={`w-2 h-2 rounded-full ${notification.type === 'success' ? 'bg-emerald-400' : 'bg-red-400'}`} />
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="px-4 py-2.5 bg-white/10 hover:bg-white/15 text-white border border-white/10 text-sm font-semibold rounded-xl transition"
            >
              Ongoing Tenders
            </button>
            <button
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <div className="bg-white/10 rounded-2xl p-5 border border-white/10 backdrop-blur-sm">
            ...
            <div className="flex items-center justify-between mt-2">
              ...
              <div className="w-10 h-10 bg-navy-800 rounded-xl flex items-center justify-center text-white">
          ...
          <div className="bg-white/10 rounded-2xl p-5 border border-white/10 backdrop-blur-sm">
            ...
            <div className="flex items-center justify-between mt-2">
              <p className="text-3xl font-black text-white">{totalEnlisted}</p>
          ...
          <div className="bg-white/10 rounded-2xl p-5 border border-white/10 backdrop-blur-sm">
            ...
            <div className="flex items-center justify-between mt-2">
              <p className="text-3xl font-black text-white">{buyerCount}</p>
              <div className="w-10 h-10 bg-navy-800 rounded-xl flex items-center justify-center text-white">
                    ...
                    <div className="flex items-start justify-between gap-4 mb-4">
                      ...
                      >
                        {enlistingId === org.organization_id ? (
                          ...
                          <>
                            <svg className="w-4 h-4 text-emerald-700" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" /></svg>
                            <span>Enlisted</span>
                          </>
                        ) : (
                          <>
